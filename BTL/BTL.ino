...
String apiKey = "IVA9NZZDP5832QOE";     //  Enter your Write API key from ThingSpeak
 
const char *ssid =  "Mr. Dien 2.4G";     // replace with your wifi ssid and wpa2 key
const char *pass =  "giongnhamay";
